...
public class Tab4Fragment extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        addsubtt = (Button)view.findViewById(R.id.add_subtt4);
        addsubtt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                addsubb.putExtra("day","Thursday");
                startActivity(addsubb);
            }
        });
        llay = view.findViewById(R.id.sub_disp_4);
        return view;
    }
    public void onStart() {
        super.onStart();
        ...
        llay.removeAllViews();
        ttlist=db.getDayTimeTables("Thursday");
