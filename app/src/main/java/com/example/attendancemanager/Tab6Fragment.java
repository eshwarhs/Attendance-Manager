...
public class Tab6Fragment extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        addsubtt = (Button)view.findViewById(R.id.add_subtt6);
        addsubtt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                addsubb.putExtra("day","Saturday");
                startActivity(addsubb);
            }
        });
        llay = view.findViewById(R.id.sub_disp_6);
        return view;
    }
    public void onStart() {
        super.onStart();
        ...
        llay.removeAllViews();
        ttlist=db.getDayTimeTables("Saturday");
